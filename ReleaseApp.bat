...
@echo 开始自动化发布
cd /d %~dp0
dotnet publish /p:JavaSdkDirectory="D:\Android\openjdk\jdk-17.0.12" /p:AndroidSdkDirectory="D:\Android\android-sdk" /p:DebugType=None /p:DebugSymbols=false App\CandySugar.MainUI\CandySugar.MainUI.csproj -f net9.0-android -c Release  -o ..\CandySugar\ReleaseApp -p:AndroidKeyStore=true -p:AndroidSigningKeyStore=candy.keystore -p:AndroidSigningKeyAlias=candy -p:AndroidSigningKeyPass=123456 -p:AndroidSigningStorePass=123456
