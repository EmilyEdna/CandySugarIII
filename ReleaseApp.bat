...
@echo 开始自动化发布
cd /d %~dp0
dotnet publish MC\CandySugar.MainUI\CandySugar.MainUI.csproj -f net7.0-android -c Debug  -o ..\CandySugar\ReleaseApp -p:AndroidKeyStore=true -p:AndroidSigningKeyStore=candy.keystore -p:AndroidSigningKeyAlias=candy -p:AndroidSigningKeyPass=123456 -p:AndroidSigningStorePass=123456
