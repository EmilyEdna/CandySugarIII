...
using CandySugar.MainUI.Models;
...
namespace CandySugar.MainUI.ViewModels
{
    public class IndexViewModel : Conductor<IScreen>
    {
        ...
        private ObservableCollection<FunctionModel> _Models;
        public ObservableCollection<FunctionModel> Models
        {
            get => _Models;
            set => SetAndNotify(ref _Models, value);
        }
        #endregion
        ...
        private void CreateMenuUI()
        {
            ...
            Models = new ObservableCollection<FunctionModel>();
            //基础插件
